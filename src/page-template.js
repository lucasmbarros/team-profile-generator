const createTeam = (teamArr) => {
  const managerInfo = (manager) => {
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item"><i class="fas fa-at"></i> <a href="mailto:${manager.getEmail()}" class="text-decoration-none .text-reset">${manager.getEmail()}</a></li>
 ...
 `;
  ...
  const engineerInfo = (engineer) => {
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item"><i class="fas fa-at"></i> <a href="mailto:${engineer.getEmail()}" class="text-decoration-none .text-reset">${engineer.getEmail()}</a></li>
      <li class="list-group-item"><i class="fab fa-github"></i> <a href="https://github.com/${engineer.getGithub()}"class="text-decoration-none .text-reset">${engineer.getGithub()}</a></li>
    </ul>
    </div>
  </div>
 `;
  ...
  <div class="card shadow" style="width: 18rem;">
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item"><i class="fas fa-at"></i> <a href="mailto:${intern.getEmail()}" class="text-decoration-none .text-reset">${intern.getEmail()}</a></li>
